    ...
    <section id="gallery" className="py-20 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {galleryItems.length > 0 ? (
          ...
          <div className="text-center py-12 bg-gray-50 rounded-3xl border border-gray-100 max-w-lg mx-auto">
            <div className="text-4xl mb-2">📸</div>
            <p className="text-sm font-fredoka font-bold text-gray-700">Hozircha fotolavhalar mavjud emas</p>
            <p className="text-xs text-gray-400 mt-1">Admin panel orqali yangi rasmlar qo'shishingiz mumkin</p>
          </div>
        )}
